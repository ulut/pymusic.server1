                            ...
                            <div class="card-panel col l8 offset-l2 m10 offset-m1 s10 offset-s1 clearfix">
                                ...
                                foreach($radios as $radio) {
                                    ...
                                    <div class="row center">
                                        <div class="meter meter-left meter-lost">
                                            <span class="" style="width: <?php echo $singer1_percent;?>%;">
                                                <i class="pin"><?php echo $singer1_percent;?>%</i>
                                            </span>
                                        </div>
                                        <div class="progress meter progress-left progress-<?php echo $singer2_total>$singer1_total?"lost":"win";?>">
                                            <div class="determinate meter-span" style="width: <?php echo $singer1_percent;?>%">
                                                <div class="pin">
                                        ...
                                        <div class="progress meter progress-right progress-<?php echo $singer2_total<$singer1_total?"lost":"win";?>">
                                            <div class="determinate meter-span" style="width: <?php echo $singer2_percent;?>%">
                                                <div class="pin">
