                                ...
                                <div class="collapsible-body">
                                    ...
                                    <ul class="collection">
										...
										foreach ($radio as $radio_item) { 
											if  (!$old_day || $old_day['date_played'] != $radio_item['date_played']) {
										?>
											<?php if  ($old_day) { ?><hr/><?php }?>
												<li class="collection-item">
													
													<div style="color:green"><i class="mdi-action-today"></i>
													<?php 
													
													echo makeDate(date('d-m-Y',strtotime($radio_item['date_played']))); ?>
													</div>
													<h6>
                                            ...
                                            <li class="collection-item">
                                                ...
                                                <h6>
                                                    ...
                                                    <span>
														...
														<?php echo date('H:i',strtotime($radio_item['time_played'])); ?>
