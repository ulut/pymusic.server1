<?php
	...
	$leader_singer[] = apc_fetch('day_leader_singer_1_'.$dateStart[0]);
	$leader_singer[] = apc_fetch('day_leader_singer_'.$dateStart[1]);
	
	$leader_song[] = apc_fetch('day_leader_song_1_'.$dateStart[0]);
	$leader_song[] = apc_fetch('day_leader_song_'.$dateStart[1]);
