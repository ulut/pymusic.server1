...
<!--    songs 4th week row-->
        ...
        <div class="col s12 m6 l3">
            <div class="card white z-depth-2 songs-list">
                <div class="card-content white-text">
                    <h4 class="card-title center-align">
                        <?php echo date("d.m", $dateStart[3]); ?> - <?php echo date("d.m", $dateLast[3]); ?>
                    </h4>
                    ...
                    <div class="card-panel">
                        ...
                        <ul class="collection">
                            ...
                            $counter=1;
                            $last_id = 0;
                            $last_week_leader_song = $leader_song[3];
                            foreach($last_week_leader_song as $key=>$singer) {
                                if ($counter==6) {
                                    $last_id = $key;
                                    break;}
                                    ...
                                    <li id="collapseSongList4">
                                        <div class="collapsible-body">
                                            ...
                                            <ul class="collection">
                                                ...
                                                <?php
                                                $counter_collapsed=6;
                                                $last_week_leader_song_collapsed = $leader_song[3];
                                                foreach($last_week_leader_song_collapsed as $key=>$singer_collapsed) {
                                                    if ($key < $last_id) continue;
                                                    if ($counter_collapsed == 51) break;
                                                    if ($key>0 && $last_week_leader_song_collapsed[$key]['melody_id'] == $last_week_leader_song_collapsed[$key-1]['melody_id']) continue;
                                        ...
                                        <div class="collapsible-header center">
                                            <button id="btnSongCollapse4" class="btn waves-effect waves-light red lighten-1" type="submit" name="action">
                                                Тизмени толук ач
                                            </button>
                                        </div>
                ...
                <div class="card-content white-text">
                    ...
                    <div class="card-panel">
                        ...
                        <ul class="collection">
                            ...
                            <?php
                            $counter=1;
                            $this_week_leader_singer = $leader_singer[3];
                            foreach($this_week_leader_singer as $key=>$singer) {
                                if ($counter==6) {
                                    break;}
                                ?>
                                    ...
                                    <li id="collapseSingerList4">
                                        <div class="collapsible-body">
                                            ...
                                            <ul class="collection">
                                                ...
                                                <?php
                                                $counter_collapsed=5;
                                                $this_week_leader_singer_collapsed = $leader_singer[3];
                                                foreach($this_week_leader_singer_collapsed as $key=>$singer_collapsed) {
                                                    if ($key < 5) continue;
                                                    if ($counter_collapsed == 51) break;
                                                    ?>
                                        ...
                                        <div class="collapsible-header center">
                                            <button id="btnSingerCollapse4" class="btn waves-effect waves-light grey" type="submit" name="action">
                                                Тизмени толук ач
                                            </button>
                                        </div>
